...
Currently, I am a Machine Learning Engineer Intern at [TikTok](https://www.tiktok.com/) working on self-evolving agents, and a research assistant in UIUC U Lab on LLM agents, multimodal agents, and agentic RL, advised by [Prof. Jiaxuan You](https://cs.stanford.edu/people/jiaxuan/).
